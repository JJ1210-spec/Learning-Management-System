-- LMS Database Schema - Fixed Version
...
CREATE TABLE courses (
    ...
    -- Fixed: Was referencing created_at instead of created_by
);
...
CREATE TABLE lessons (
    ...
    title VARCHAR(255) NOT NULL,  -- Fixed: Was INT, should be VARCHAR
...
CREATE TABLE enrollments (
    ...
    course_id INT NOT NULL,
    enrolled_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,  -- Fixed: Had dot instead of comma
...
-- Insert Lessons for Course 1 (Web-Tech Basics)
...
-- Insert Lessons for Course 2 (Database Management)
INSERT INTO lessons (course_id, title, lesson_order) VALUES
...
-- Insert Lessons for Course 3 (Data Science Essentials)
INSERT INTO lessons (course_id, title, lesson_order) VALUES
